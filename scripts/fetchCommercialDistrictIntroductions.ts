...
const TARGET = path.join(RAW_DIR, 'commercial-district-introductions.csv');
const LOCAL_UPLOAD = '/Users/Leo/Downloads/114年6月臺北市商圈介紹.csv';
const SOURCE_URL =
  'https://data.taipei/api/frontstage/tpeod/dataset/resource.download?rid=bdc97a2a-cdfd-4fd3-b7ac-62dd34d384be';
...
try {
  ...
  note = 'Downloaded official Taipei commercial district introductions CSV.';
} catch (error) {
